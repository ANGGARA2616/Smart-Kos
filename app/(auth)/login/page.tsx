            ...
            <Card className="w-full max-w-md shadow-lg border-none">
                <CardBody className="p-8">
                    <div className="text-center mb-8">
                        <h1 className="text-2xl font-bold text-gray-900">Masuk SmartKos</h1>
                        <p className="text-gray-500 text-sm mt-2">Selamat datang kembali! Silakan masuk ke akunmu.</p>
                    </div>
